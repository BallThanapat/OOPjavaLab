...
public class CalculatorSample implements ActionListener {
    ...
    private JButton plus, minus, multi, divide, equal, clear, ext;
    private JPanel p;
    private int num1;
    private String opr;
    private int num2;
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource().equals(plus)||ae.getSource().equals(minus)||ae.getSource().equals(multi)||ae.getSource().equals(divide)){
